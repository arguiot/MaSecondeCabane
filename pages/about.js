...
export default function About() {
    ...
    <Page style={{ fontFamily: "var(--fancyFont)" }}>
        ...
        <Text p align="justify">
            Acheter en seconde main ne veut pas dire de mauvaise qualité, au contraire ! Des vêtements encore neufs, ou peut utilisés ou encore en parfaite condition, nous en avons tous dans les penderies de nos enfants. Imaginez qu'entre 0 et 1 an, les vêtements ne sont portés que quelques semaines... Créer un vide dressing chic et de qualité pour que nous puissions partager tous ensemble nos trésors.
        </Text>
